export class CaptionRecorder {
    ...
    protected observedElement: string = ".iOzk7";
    ...
    handleCharacterData(mutation: MutationRecord) {
        ...
        if (
            ...
            this.captions = this.captions.substring(
                0,
                this.captions.lastIndexOf(mutation.oldValue.trim())
            );
            appendValue = true;
    ...
    handleChildList(mutation: MutationRecord) {
